 ...
 * console.log("获取权限列表！"); $.get('/CIMS/login/getUserPermission.do',
 * function(data) { permissionList = data.permission; //console.log("身份是：" +
 ...
 * value); var hasPermission = permissions.hasPermission(value);// hasPermission
 * console.log("是否有这个权限：" + hasPermission); if (hasPermission) element.show();
 * else element.hide(); } toggleVisibilityBasedOnPermission();
