...
<section class="leftbar">
	...
	<dl class="leftmenu hideE" id="assistant2">
		...
		<dd>
			...
			<ul class="menuson">
				<li><cite></cite> <a id="taskFirst"  href="${ctx}/task/toTaskPage.do#/newTask">新消息</a><i></i></li>
	...
	<dl class="leftmenu hideE" id="manager">
		...
		<dd>
			<div class="title">
				...
				<ul class="menuson">
				<li><cite></cite> <a  id="mContractFirst" href="${ctx}/contract/toManagerContractPage.do#/contractList">合同信息管理</a><i></i></li>
